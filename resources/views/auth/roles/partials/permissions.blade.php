...
<div class="bs-example">
    ...
    <li class="nav-item">
        ...
        <li class="nav-item">
            <a href="#investments" class="nav-link" data-toggle="tab">Expenses</a>
        </li>
    ...
    <div class="tab-pane fade show" id="accounts">
        ...
        <div class="tab-pane fade show" id="investments">
                  <h4 class="mt-2">{{__('Expenses permissions')}}</h4>
                  @foreach(Spatie\Permission\Models\Permission::where('model', 'like','%Expense%')->get() as $permission)
