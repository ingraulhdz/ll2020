                        ...
                        <div class="col-md-3 s-1 wow slideInLeft" data-wow-duration="1s" data-wow-delay=".3s">
                            <a href="#">
                                <div class="view view-fifth">
                                    ...
                                    <div class="mask">
                                        <h4>Lienzo Charro</h4>
                                        <p>El proyecto mas reciente, un lienzo charro para inculcar el deporte de la
                                            charreria en la juventud.</p>
                            ...
                            <a href="#">
                                <div class="view view-fifth">
                                    ...
                                    <div class="mask">
                                        ...
                                        <p>Continuamente se realizan tareas para dar un mejor aspecto a el centro de la
                                            comunidad</p>
                                    </div>
                        ...
                        <div class="col-md-3 s-3 wow slideInRight" data-wow-duration="1s" data-wow-delay=".3s">
                            <a href="#">
                                <div class="view view-fifth">
                                    ...
                                    <div class="mask">
                                        <h4>Futbol Rapido</h4>
                                        <p> Reactivacion de la cancha de futbol rapido para que los jovenes sigan
                                            practicando futbol.</p>
                                    </div>
